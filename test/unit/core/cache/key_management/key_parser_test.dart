...
void main() {
  ...
  group('缓存键解析边界情况测试', () {
    ...
    test('应该处理空版本的情况', () {
      const emptyVersionKey = 'jisu_fund_fundData_test@';
  ...
  group('缓存键信息对象测试', () {
    ...
    test('CacheKeyInfo应该正确生成description', () {
      const infoWithoutParams = CacheKeyInfo(
        type: CacheKeyType.fundData,
        identifier: '161725',
        version: 'latest',
        params: [],
      ...
      const infoWithParams = CacheKeyInfo(
        type: CacheKeyType.searchIndex,
        identifier: 'fund_name',
        version: 'v1',
        params: ['pinyin', 'sort'],
