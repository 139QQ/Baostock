...
// in jisu_fund_analyzer/test/services/story_r2_integration_test.dart.
...
class MockCacheService extends _i1.Mock implements _i8.CacheService {
  ...
  @override
  _i9.Future<List<String>> getAllKeys() => (super.noSuchMethod(
        Invocation.method(
          #getAllKeys,
          [],
        ),
  ...
  @override
  _i9.Future<Map<String, dynamic>> getAll(List<String>? keys) =>
      (super.noSuchMethod(
        Invocation.method(
          #getAll,
          [keys],
  ...
  @override
  _i9.Future<void> removeAll(List<String>? keys) => (super.noSuchMethod(
        Invocation.method(
          #removeAll,
          [keys],
        ),
  ...
  @override
  _i9.Future<Duration?> getExpiration(String? key) => (super.noSuchMethod(
        Invocation.method(
          #getExpiration,
          [key],
        ),
