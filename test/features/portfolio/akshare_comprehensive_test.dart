  ...
  group('AKShare全面API接口测试', () {
    ...
    group('1. 开放式基金接口测试', () {
      test('fund_open_fund_daily_em - 实时数据接口', () async {
        ...
        const apiUrl = '$baseUrl/fund_open_fund_daily_em';
    ...
    group('2. 货币型基金接口测试', () {
      test('fund_money_fund_daily_em - 实时数据接口', () async {
        ...
        const apiUrl = '$baseUrl/fund_money_fund_daily_em';
    ...
    group('3. 理财型基金接口测试', () {
      test('fund_financial_fund_daily_em - 实时数据接口', () async {
        ...
        const apiUrl = '$baseUrl/fund_financial_fund_daily_em';
    ...
    group('4. 分级基金接口测试', () {
      test('fund_graded_fund_daily_em - 实时数据接口', () async {
        ...
        const apiUrl = '$baseUrl/fund_graded_fund_daily_em';
    ...
    group('5. 场内交易基金接口测试', () {
      test('fund_etf_fund_daily_em - 实时数据接口', () async {
        ...
        const apiUrl = '$baseUrl/fund_etf_fund_daily_em';
