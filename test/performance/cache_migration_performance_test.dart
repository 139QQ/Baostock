...
class CacheMigrationPerformanceTester {
  ...
  Map<String, PerformanceBenchmark> _getPerformanceBenchmarks() {
    return {
      'cache_key_generation': const PerformanceBenchmark(
        minThroughput: 5000,
        maxDuration: Duration(seconds: 5),
        maxMemoryUsageMB: 100,
        description: '缓存键生成性能测试',
      ),
      'cache_key_parsing': const PerformanceBenchmark(
        minThroughput: 3000,
        maxDuration: Duration(seconds: 5),
        maxMemoryUsageMB: 80,
        description: '缓存键解析性能测试',
      ),
      'batch_operations': const PerformanceBenchmark(
        minThroughput: 2000,
        maxDuration: Duration(seconds: 10),
        maxMemoryUsageMB: 150,
        description: '批量操作性能测试',
      ),
      'large_scale_migration': const PerformanceBenchmark(
        minThroughput: 1000,
        maxDuration: Duration(seconds: 30),
        maxMemoryUsageMB: 200,
        description: '大规模迁移性能测试',
      ),
      'concurrent_operations': const PerformanceBenchmark(
        minThroughput: 800,
        maxDuration: Duration(seconds: 15),
        maxMemoryUsageMB: 180,
        description: '并发操作性能测试',
      ),
      'memory_efficiency': const PerformanceBenchmark(
        minThroughput: 500,
