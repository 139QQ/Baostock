...
class MemoryManagementService {
  ...
  void _recordPerformance(String operation, [dynamic value]) {
    ...
    _performanceMetrics['${operation}_$timestamp'] = value ?? true;
...
class MemoryStatus {
  ...
  @override
  String toString() {
    return 'MemoryStatus(usage: $currentUsageMB, max: $maxUsageMB, cacheItems: $cacheItemCount, gcCount: $totalGcCount)';
  }
}
