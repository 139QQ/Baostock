...
class SearchLoadInProgress extends SearchState {
  ...
  SearchLoadInProgress({this.criteria});
...
class SearchLoadSuccess extends SearchState {
  ...
  String get performanceSummary {
    ...
    return '平均搜索时间: ${avgTime}ms, 缓存: $cacheSize';
  }
}
...
class SearchHistoryLoadSuccess extends SearchState {
  ...
  SearchHistoryLoadSuccess({required this.history});
...
class SearchSuggestionsLoadInProgress extends SearchState {
  ...
  SearchSuggestionsLoadInProgress({required this.keyword});
...
class SearchStatisticsLoaded extends SearchState {
  ...
  SearchStatisticsLoaded({required this.statistics});
...
class SearchOptionsUpdated extends SearchState {
  ...
  SearchOptionsUpdated({required this.updatedCriteria});
...
class SearchFieldsUpdated extends SearchState {
  ...
  SearchFieldsUpdated({required this.searchFields});
...
class SearchSortUpdated extends SearchState {
  ...
  SearchSortUpdated({required this.sortBy});
...
class SearchHistoryDeleted extends SearchState {
  ...
  SearchHistoryDeleted({required this.deletedKeyword});
...
class SearchRetry extends SearchState {
  ...
  /// 获取重试消息
  String get retryMessage => '正在重试搜索（第$attemptCount次）';
}
