...
class FundManagerInfo extends StatelessWidget {
          ...
          children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        '从业${manager.totalManageDuration}�?,
                        style: TextStyle(
                          fontSize: 14,
            ...
            Row(
              ...
              children: [
                _buildMetricItem(
                  '管理基金',
                  '${manager.currentFundCount}�?,
                  Colors.blue,
                ),
                _buildMetricItem(
                  '管理规模',
                  '${manager.totalAssetUnderManagement.toStringAsFixed(0)}�?,
                  Colors.green,
                ),
                _buildMetricItem(
                  '平均年化',
  ...
  Widget _buildStyleTags() {
    final styles = ['价值投�?, '长期持有', '稳健收益', '低换手率'];
  ...
  Widget _buildFundList() {
    // 模拟当前管理基金数据
    final funds = [
      {'name': '易方达蓝筹精选混�?, 'code': '005827', 'return': 22.3},
      {'name': '易方达优质精选混�?, 'code': '110011', 'return': 18.7},
