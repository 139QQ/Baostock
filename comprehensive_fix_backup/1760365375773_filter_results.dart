                ...
                children: [
                  Expanded(
                    child: _buildMetricItem(
                      '近一年收益',
                      '${fund.return1Year?.toStringAsFixed(2) ?? '--'}%',
                      fund.return1Year != null && fund.return1Year! > 0
                          ? colors.success
                          : colors.error,
                    ),
                  ),
                  Expanded(
                    child: _buildMetricItem(
                      '近三年收益',
                      '${fund.return3Year?.toStringAsFixed(2) ?? '--'}%',
                      fund.return3Year != null && fund.return3Year! > 0
                          ? colors.success
                          : colors.error,
                    ),
                  ),
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      '${fund.return1Year?.toStringAsFixed(2) ?? '--'}%',
                      style: theme.textTheme.titleMedium?.copyWith(
                        color: fund.return1Year != null && fund.return1Year! > 0
                            ? colors.success
                            : colors.error,
                        fontWeight: FontWeight.bold,
                      ),
