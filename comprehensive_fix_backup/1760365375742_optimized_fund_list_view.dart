...
class _OptimizedFundListViewState extends State<OptimizedFundListView>
  ...
  FundRanking _convertToFundRanking(
    ...
    return FundRanking(
      ...
      return1W: _parsePercentage(data['近1周']),
      return1M: _parsePercentage(data['近1月']),
      return3M: _parsePercentage(data['近3月']),
      return6M: _parsePercentage(data['近6月']),
      return1Y: _parsePercentage(data['近1年']),
      return2Y: _parsePercentage(data['近2年']),
      return3Y: _parsePercentage(data['近3年']),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text('暂无数据', style: TextStyle(color: Colors.grey.shade700)),
        ],
      ),
    );
  }
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          Text('加载失败', style: TextStyle(color: Colors.red.shade700)),
